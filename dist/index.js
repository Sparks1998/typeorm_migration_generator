...
program.version('0.1.0').arguments('<name>').description('Create a new TypeORM migration').action((name) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
export class ${fileName}${timestamp} implements MigrationInterface {
	name = '${getStringNoMigrationWord(fileName)}'
        ...
        fs.mkdir(directoryName, {
            ...
            if (err) {
                ...
                if (!fs.existsSync(path.resolve(directoryName, "DynamicColumns.ts"))) {
                    fs.writeFileSync(path.resolve(directoryName, "DynamicColumns.ts"), DynamicColumns_1.dynamicColumnsString);
                }
